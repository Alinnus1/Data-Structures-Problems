...
int main()
{
    ...
    cout <<"timpul sortarii radix este :"<< duration2.count() << " microsecunde"<<endl;

    auto start3 = high_resolution_clock::now();
    MergeSort(v3);
    auto stop3 = high_resolution_clock::now();
    auto duration3 = duration_cast<microseconds>(stop3 - start3);
    cout <<"timpul sortarii merge este :"<< duration3.count() << " microsecunde"<<endl;

    auto start4 = high_resolution_clock::now();
    QuickSort(v4,0,v4.size());
    auto stop4 = high_resolution_clock::now();
    auto duration4 = duration_cast<microseconds>(stop4 - start4);
    cout <<"timpul sortarii quicksort este :"<< duration4.count() << " microsecunde"<<endl;

    auto start1 = high_resolution_clock::now();
    Countsort(v1);
    auto stop1 = high_resolution_clock::now();
    auto duration1 = duration_cast<microseconds>(stop1 - start1);
    cout <<"timpul sortarii count este :"<< duration1.count() << " microsecunde"<<endl;

    auto start = high_resolution_clock::now();
    Bubblesort(v);
    auto stop = high_resolution_clock::now();
    auto duration = duration_cast<microseconds>(stop - start);
    cout <<"timpul sortarii bubble este :"<< duration.count() << " microsecunde"<<endl;
